...
GRAPHIC_KERNEL_PREMIUM_FILES = $(wildcard $(GRAPHIC_KERNEL_DIR)/*.desktop)
...
install_bash_files:
	...
	$(INSTALL) 0755 gosc $(DESTDIR)$(OPT_DIR)/$(PROG_NAME)
	...
	$(INSTALL) 0755 nvidia $(DESTDIR)$(OPT_DIR)/$(PROG_NAME)
	$(INSTALL) 0755 procedury $(DESTDIR)$(OPT_DIR)/$(PROG_NAME)
	$(INSTALL) 0755 radeon $(DESTDIR)$(OPT_DIR)/$(PROG_NAME)
